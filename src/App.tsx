  ...
  return (
    <div className="min-h-screen px-4 cyber-grid">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500 rounded-full blur-3xl opacity-5 animate-pulse cyber-float"></div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-cyan-500 rounded-full blur-3xl opacity-5 animate-pulse" style={{animationDelay: '4s'}}></div>
